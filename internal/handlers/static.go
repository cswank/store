...
func Init(box *rice.Box) {
	...
	for _, pth := range []string{"head.html", "base.html", "navbar.html", "index.html", "login.html", "items.html", "item.html", "thumb.html", "subcategory.html", "admin.html", "confirm.html", "confirm.js"} {
